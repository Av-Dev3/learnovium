            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    { days: 7, label: "Week Warrior", achieved: true },
                    { days: 14, label: "Fortnight Fighter", achieved: true },
                    { days: 30, label: "Month Master", achieved: false },
                    { days: 100, label: "Century Champion", achieved: false }
                  ].map((milestone) => (
