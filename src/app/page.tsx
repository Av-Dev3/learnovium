        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div 
              ...
              className={`inline-flex items-center gap-2 rounded-full px-6 py-3 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-lg transition-all duration-1000 ${
                animatedElements.has('hero-badge') ? 'animate-in' : 'animate-on-scroll'
              }`}
            >
              <Sparkles className="w-4 h-4 text-brand" />
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">AI-Powered Learning Platform</span>
            </div>
            ...
            >
              ...
              <br />
              <span className="text-brand" style={{animationDelay: '0.4s'}}>AI-Powered</span>
              <br />
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card 
              ...
              className={`group relative border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 rounded-3xl ${
                animatedElements.has('feature-1') ? 'animate-in' : 'animate-on-scroll'
              }`}
            >
              <CardHeader className="text-center pb-6">
                <div className="mx-auto w-20 h-20 bg-brand rounded-3xl flex items-center justify-center mb-6">
            ...
            >
              <CardHeader className="text-center pb-6">
                <div className="mx-auto w-20 h-20 bg-emerald-500 rounded-3xl flex items-center justify-center mb-6">
            ...
            >
              <CardHeader className="text-center pb-6">
                <div className="mx-auto w-20 h-20 bg-purple-500 rounded-3xl flex items-center justify-center mb-6">
            ...
            >
              <CardHeader className="text-center pb-6">
                <div className="mx-auto w-20 h-20 bg-orange-500 rounded-3xl flex items-center justify-center mb-6">
