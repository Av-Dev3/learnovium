          ...
          <div className="flex items-center space-x-4">
            ...
            {!isLoggedIn ? (
              ...
              <div className="relative">
                ...
                {userMenuOpen && (
                  <>
                    {/* Debug info - This should always be visible */}
                    ...
                    <div className="fixed top-20 right-4 z-[9999] w-80 bg-red-500 border-4 border-yellow-400 p-4 text-white text-center">
                      <div className="text-lg font-bold">🎯 MENU IS HERE! 🎯</div>
                      <div className="text-sm">userMenuOpen: {userMenuOpen.toString()}</div>
                      <div className="text-sm">isLoggedIn: {isLoggedIn.toString()}</div>
                      <button 
                        onClick={() => setUserMenuOpen(false)}
